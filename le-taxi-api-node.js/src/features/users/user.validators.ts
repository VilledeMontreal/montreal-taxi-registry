...
function updateInquiriesStartTime(
  ...
  if (
    ...
    user.standard_booking_inquiries_starts_at =
      user.standard_booking_is_promoted_to_public ? startTime : null;
  }
  ...
  if (
    ...
    user.minivan_booking_inquiries_starts_at =
      user.minivan_booking_is_promoted_to_public ? startTime : null;
  }
  ...
  if (
    ...
    user.special_need_booking_inquiries_starts_at =
      user.special_need_booking_is_promoted_to_public ? startTime : null;
  }
...
function sanitizeDto(userRequestDto: UserRequestDto): UserRequestDto {
  ...
  user.minivan_booking_is_available_from_web_url =
    user.minivan_booking_is_available_from_web_url ?? false;
  user.minivan_booking_is_available_from_android_uri =
    user.minivan_booking_is_available_from_android_uri ?? false;
  user.minivan_booking_is_available_from_ios_uri =
    user.minivan_booking_is_available_from_ios_uri ?? false;
  user.minivan_booking_is_promoted_to_public =
    user.minivan_booking_is_promoted_to_public ?? false;
  user.special_need_booking_is_promoted_to_public =
    user.special_need_booking_is_promoted_to_public ?? false;
  return user;
}
