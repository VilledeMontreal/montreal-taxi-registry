...
import { defineCopyTemplate, defineCopyTemplateVariation } from '../shared/copyTemplate/copyTemplate';
...
export const copyAdsPermitTemplate = defineCopyTemplateVariation(copyAdsOwnerTemplate, items => {
