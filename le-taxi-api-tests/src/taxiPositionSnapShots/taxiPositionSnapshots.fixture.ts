...
import { copyTaxiPositionSnapShotItemTemplate, copyTaxiPositionTemplate } from './taxiPositionSnapShotsDto.template';
...
export async function setTaxiPosition(snapshot: Partial<ITaxiPositionSnapShotItem>, apiKey?: string) {
  const dtoUpdateTaxiPosition = copyTaxiPositionTemplate(x => {
