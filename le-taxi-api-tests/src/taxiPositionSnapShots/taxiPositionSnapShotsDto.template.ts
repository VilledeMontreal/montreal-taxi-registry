...
export const copyTaxiPositionSnapShotItemTemplate =
  defineCopyTemplate<ITaxiPositionSnapShotItem>({
...
export const copyTaxiPositionTemplate =
  defineCopyTemplate<ITaxiPositionSnapShots>({
