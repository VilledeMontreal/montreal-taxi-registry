...
exports.list = function(failures) {
  ...
  failures.forEach(function(test, i) {
    ...
    if (!isTestAssertion(err) && errorHasSomeExtraInformation(err)) {
      const errorJsonWithoutCycles = getErrorJsonWithoutCycles(err);
      const completeError = `${JSON.stringify(errorJsonWithoutCycles, null, 2)}`.replace(/^/gm, '      ');
      stack += '\n\n      Unexpected Error:\n' + completeError;
    }
...
function getErrorJsonWithoutCycles(error) {
  var err = error || {};
  return cleanCycles(err);
}
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// function below are copied from mocha/lib/reporters/json.js
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
